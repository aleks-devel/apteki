...
import { RatingStars } from "@/app/(mainPage)/_common/RatingStars";
import { ClockSVG } from "@/app/(mainPage)/_layout/PharmaSearchBar/ClockSVG";
import style from "@/app/(mainPage)/_layout/PharmaSearchBar/style.module.scss";
